...
public class CreateCalibrationRecordCommand
    : IRequest<Either<CalibrationRecordException, CalibrationRecord>>,
        IValidatableModel<CreateCalibrationRecordCommand>
{
    ...
    public IValidator<CreateCalibrationRecordCommand> ValidateApplicationModel(
        ApplicationBaseValidationModelProvider<CreateCalibrationRecordCommand> validator)
    {
