...
public class UpdateDevicePollutantCapabilityDtoValidator
    : AbstractValidator<UpdateDevicePollutantCapabilityDto>
{
    public UpdateDevicePollutantCapabilityDtoValidator()
    {
